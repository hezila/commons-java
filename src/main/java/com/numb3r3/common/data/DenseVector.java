package com.numb3r3.common.data;
...
import com.numb3r3.common.math.stat.RandomUtil;
...
public class DenseVector {
    ...
    public void init(double mean, double sigma) {
        for (int i = 0; i < size; i++)
            data[i] = RandomUtil.gaussian(mean, sigma);
    }
    ...
    public void init(double range) {
        for (int i = 0; i < size; i++)
            data[i] = RandomUtil.uniform(0.0, range);
    }
