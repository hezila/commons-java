...
import com.numb3r3.common.collection.Mapper;
import com.google.common.collect.Iterators;
import com.numb3r3.common.collection.TranslatingIterator;
...
public class CounterMap<K> implements Iterable<Map.Entry<K, Long>> {
    ...
    public Iterator<Map.Entry<K, Long>> iterator() {
        return Iterators.unmodifiableIterator(
                new TranslatingIterator<Entry<K, AtomicLong>, Entry<K, Long>>(
