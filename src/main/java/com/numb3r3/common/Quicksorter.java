...
public class Quicksorter<T extends Comparable<T>> {
     ...
     *
     * @param array     the array to sort
     * @param lowIndex  the index of the first element of the subarray to sort.
     * @param highIndex the index of the last element of the subarray to sort.
     */
     ...
     *
     * @param smallSubarrayThreshold the threshold to set
     */
