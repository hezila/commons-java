...
public class NativeIntegerMatrix {
	private int numOfRow;
	private int numOfColumn;
	private int [][] row;
	
	public NativeIntegerMatrix(int numOfRow, int numOfColumn){
	...
	public NativeIntegerMatrix(int numOfRow, int numOfColumn, String fileType, String file) throws Exception{
		String line;
		int lineNumber=0;
		this.numOfRow = numOfRow;
		this.numOfColumn = numOfColumn;
	...
	public NativeIntegerMatrix copy() {
		NativeIntegerMatrix temp = new NativeIntegerMatrix(this.numOfRow, this.numOfColumn);
