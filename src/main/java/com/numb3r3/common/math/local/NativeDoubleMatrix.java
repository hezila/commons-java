...
public class NativeDoubleMatrix {
    private int numOfRow;
    private int numOfColumn;
    private double[][] row;

    public NativeDoubleMatrix(int numOfRow, int numOfColumn) {
    ...
    public NativeDoubleMatrix(int numOfRow, int numOfColumn, String fileType, String file) throws Exception {
        String line;
        int lineNumber = 0;
        this.numOfRow = numOfRow;
        this.numOfColumn = numOfColumn;
    ...
    public NativeDoubleMatrix copy() {
        NativeDoubleMatrix temp = new NativeDoubleMatrix(this.numOfRow, this.numOfColumn);
